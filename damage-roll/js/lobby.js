...
function _lobbyReceiveChat(payload) {
    ...
    _lobbyAppendChat(payload, false);
}
...
function _lobbyViewProfile(uid) {
    // TODO: open a profile viewer modal for the target uid
    // For now, show a placeholder system message
    _lobbyChatSystem('Profile viewer coming soon.');
}
