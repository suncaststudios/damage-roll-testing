...
const THEMES = ['default','blood','arcane','ocean','forest','ash','gold','ice'];
...
function applyTheme(theme) {
    ...
    const themeStyles = {
        ...
        blood:   { inputBg:'rgba(15,2,2,0.85)',     inputBorder:'rgba(120,30,20,0.5)',   inputColor:'#e09080', btnBg:'rgba(30,5,5,0.9)',   btnBorder:'rgba(120,20,20,0.5)', btnColor:'#c08080' },
        arcane:  { inputBg:'rgba(10,2,20,0.85)',    inputBorder:'rgba(90,20,140,0.5)',   inputColor:'#c090e0', btnBg:'rgba(15,5,30,0.9)',  btnBorder:'rgba(90,20,140,0.5)', btnColor:'#c090e0' },
        ocean:   { inputBg:'rgba(0,6,18,0.85)',     inputBorder:'rgba(20,70,140,0.5)',   inputColor:'#80c0e0', btnBg:'rgba(0,8,22,0.9)',   btnBorder:'rgba(20,70,140,0.5)', btnColor:'#6090c0' },
        forest:  { inputBg:'rgba(2,8,1,0.85)',      inputBorder:'rgba(20,80,15,0.5)',    inputColor:'#80b060', btnBg:'rgba(3,10,2,0.9)',   btnBorder:'rgba(20,80,15,0.5)',  btnColor:'#60a040' },
        ash:     { inputBg:'rgba(12,12,12,0.85)',   inputBorder:'rgba(70,70,70,0.5)',    inputColor:'#aaaaaa', btnBg:'rgba(15,15,15,0.9)', btnBorder:'rgba(70,70,70,0.5)',  btnColor:'#888888' },
        gold:    { inputBg:'rgba(20,14,2,0.85)',    inputBorder:'rgba(140,90,10,0.5)',   inputColor:'#e0c060', btnBg:'rgba(25,17,2,0.9)',  btnBorder:'rgba(140,90,10,0.5)', btnColor:'#c8a040' },
        ice:     { inputBg:'rgba(0,14,30,0.85)',    inputBorder:'rgba(20,110,170,0.55)',  inputColor:'#90c8e0', btnBg:'rgba(0,18,38,0.9)',  btnBorder:'rgba(20,110,170,0.55)', btnColor:'#6aaac8' },
    };
